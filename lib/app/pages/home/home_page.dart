              ...
              Expanded(
                child: ListView.separated(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    // checar se esse produto já existe na Sacola para repassar pra página de Detalhe
                    final orderHasThisProduct = state.shoppingBag
                        .where((order) => order.product == product);
                    return DeliveryProductTile(
                      product: product,
                      orderProduct: orderHasThisProduct.isNotEmpty
                          ? orderHasThisProduct.first
                          : null,
                    );
                  },
                ),
